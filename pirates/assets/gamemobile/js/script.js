...
$(document).ready(function () {
    ...
    jQuery('.ships .battleship-cell').on('click', function (e) {
        e.preventDefault();
    ...
    jQuery('.js-start').on('click', function (e) {
        ...
        jQuery('.maingame').show();
    });

    jQuery('.aside').on('click', function (e) {
        jQuery(this).toggleClass('slim');
    });

   /* jQuery('.aside-close').on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();

        jQuery('.aside').addClass('slim');
    });*/
