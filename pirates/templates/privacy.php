...
<body class="bg-white">
<div class="root privacy">
    <div class="aside">
        <a href="/?tmpl=game" class="aside-logo"></a>
        <h2>Будет полезно:</h2>
        <a target="_blank" href="https://vk.com/app5898182_-190654119#s=647856&force=1" class="btn btn--vk">Подписаться <br>на полезности</a>
        <a href="/?tmpl=game" class="btn btn--white">Вернуться в начало  <br>игросайта</a>
    </div>
    <div class="maingame">
        <section class="maingame-header">
            <div class="maingame-header-phone">
                <div class="maingame-header-phone__num"><a href="tel:+79091503444">+7 (909) 150-34-44</a></div>
            </div>
        </section>
        <section class="content">
            <h1 class="big-yellow">Политика <br>конфеденциальности</h1>
            <h5>1. Общие положения</h5>
            <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. №152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных ИП Лукьян Дмитрий Михайлович (далее – Оператор).</p>
            <ol>
                ...
                <li>Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта http://pirats.studio.</li>
            </ol>
            ...
            <ol>
                ...
                <li>Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу http://pirats.studio;</li>
                ...
                <li>Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта http://pirats.studio;</li>
                <li>Пользователь – любой посетитель веб-сайта http://pirats.studio;</li>
            ...
            <ol>
                <li>Цель обработки персональных данных Пользователя — Обработка заказов.</li>
                <li>Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах, специальных предложениях и различных событиях. Пользователь всегда может отказаться от получения информационных сообщений, направив Оператору письмо на адрес электронной почты me@ldmco.ru с пометкой «Отказ от уведомлениях о новых продуктах и услугах и специальных предложениях».</li>
            ...
            <ol>
                <li>Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте http://pirats.studio. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.</li>
            ...
            <ol>
                ...
                <li>В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора me@ldmco.ru с пометкой «Актуализация персональных данных».</li>
                <li>Срок обработки персональных данных является неограниченным. Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора me@ldmco.ru с пометкой «Отзыв согласия на обработку персональных данных».</li>
            </ol>
            ...
            <ol>
                <li>Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты me@ldmco.ru.</li>
                ...
                <li>Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу http://pirats.studio/?tmpl=privacy.</li>
            </ol>
            <br>
            <h5>Реквизиты</h5>
            <p>Наименование предприятия: Индивидуальный предприниматель Лукьян Дмитрий Михайлович</p>
            <p>Краткое наименование: ИП Лукьян Дмитрий Михайлович</p>
            <p>Юридический адрес: 124460, г. Москва, г. Зеленоград, корп. 1106, кв. 56</p>
            <p>Телефон: 8 (909) 150-34-44</p>
            <p>Почтовый адрес: 124460, г. Москва, г. Зеленоград, корп. 1106, кв. 56</p>
            <p>Email: me@ldmco.ru</p>
            <p>Телефон: 8 (909) 150-34-44</p>
            <p>ИНН: 773571770187</p>
            <p>ОГРН: 313774609200207</p>

            <h5>Платежные реквизиты</h5>
            <p>Счет №: 40802810570010040014</p>
